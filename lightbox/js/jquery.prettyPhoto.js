			...
			markup: '<div class="pp_pic_holder"> \
						...
						<div class="pp_content_container"> \
							...
							<div class="pp_right"> \
								...
								<a class="pp_next" href="#">&rarr;</a> \
								<a class="pp_previous" href="#">&larr;</a> \
									<div class="pp_loaderIcon"></div> \
									<div class="pp_fade"> \
										<a href="#" class="pp_expand" title="Expand the image">Expand</a> \
										<div class="pp_hoverContainer"> \
											<p class="currentTextHolder">0/0</p> \
											<div class="info-overlay">&nbsp;{pp_social}</div>\
											<div class="ppt">&nbsp;</div>\
										</div> \
		...
		*/
		function _showContent(){
			...
			$('.pp_hoverContainer').hover(function(){
					$(".info-overlay").fadeTo(settings.animation_speed,0.8);
					$ppt.fadeTo(settings.animation_speed,1);
					}, function(){
						$(".info-overlay").fadeTo(settings.animation_speed,0);
						$ppt.fadeTo(settings.animation_speed,0);
						})
			//titleMiddle = $(".pp_fade").height();
//			theContMiddle = titleMiddle/2;
//			setTimeout(
//				   function(){
//					   alert(theContMiddle);
//					  $ppt.css('padding-top', theContMiddle);
//
//				   }, 500);
